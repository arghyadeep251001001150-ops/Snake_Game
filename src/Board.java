...
public class Board extends JPanel implements ActionListener {
    ...
    private final int NORMAL_DELAY = 140;
    private final int FAST_DELAY = 70;
    ...
    private void updateSpeedMode() {
        boolean boostOn = leftKeyPressed || rightKeyPressed || upKeyPressed || downKeyPressed;
        timer.setDelay(boostOn ? FAST_DELAY : NORMAL_DELAY);
    }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString(restartMsg, (300 - metrics.stringWidth(restartMsg)) / 2, (300 / 2) + 20);
    }
